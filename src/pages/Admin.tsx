...
export const Admin = () => {
  ...
  const [activeTab, setActiveTab] = useState<"properties" | "cities">(
    "properties",
  );
  ...
  const shareToFacebook = (property: Property) => {
    ...
    if (!url) {
      alert(
        "تعذر إنشاء رابط مشاركة عام. اضبط VITE_PUBLIC_SITE_URL على رابط الموقع المنشور مثل https://example.com",
      );
      return;
    }
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setFilters({
                        ...filters,
                        finishingStatus: e.target.value,
                      })
                    }
                    className="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-transparent bg-white"
                  >
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setFilters({ ...filters, handoverStatus: e.target.value })
                    }
                    className="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-transparent bg-white"
                  >
                    <option value="">الكل</option>
